...
code_organization:
  ...
  tiers:
    tier_0: ["go"]                  # Native reference implementation
    tier_a: ["cpp", "rust", "zig"]  # Native implementations
    tier_b: ["swift", "dart", "java", "csharp"]  # FFI to C ABI
    igniffi: ["python", "javascript", "php", "ruby"]  # Via C ABI + thin FFI wrappers
