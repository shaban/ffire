...
validation:
  ...
  known_architectural_violations:
    ...
    python_generator:
      file: "pkg/generator/generator_python_ctypes.go, generator_python_pybind11.go"
      issue: "FIXED: Both variants now generate 'class ConfigMessage'"
      status: "✅ fixed"
...
- Python generators (both ctypes and pybind11)
- JavaScript generator (class {Name}Message)
- C ABI generator (bare lowercase names)

**⚠️ Known Issues:**
- None - all generators now comply with Message suffix architecture
...
**Benchmark Results:**
- All 5 active languages (Go, C++, Swift, Dart, JavaScript) passing 10/10 tests
- Python requires installation/configuration
